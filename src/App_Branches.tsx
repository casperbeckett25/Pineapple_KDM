...
/* Floating emojis (keeps decorations from previous version) */
const FloatingEmojis: React.FC = () => {
  const emojis = [
    { e: '🚗', top: '10%', left: '8%', size: 36, delay: '0s' },
    { e: '✨', top: '20%', left: '80%', size: 28, delay: '1s' },
    { e: '💸', top: '70%', left: '10%', size: 32, delay: '2s' },
    { e: '🛡️', top: '55%', left: '75%', size: 30, delay: '0.6s' },
    { e: '🎉', top: '42%', left: '45%', size: 26, delay: '1.5s' },
    { e: '🤝', top: '85%', left: '60%', size: 30, delay: '0.9s' },
  ];
...
/* Floating car silhouette: renders multiple cars (LTR and RTL sweeps) */
const FloatingCarSilhouette: React.FC = () => (
  <div aria-hidden className="floating-car-wrapper">
    {/* Left-to-right decorative car (keeps previous LTR sweep on left side) */}
    <Car
      className="floating-car ltr large delay-1"
      style={{ top: '12%', left: '-12%', position: 'absolute' }}
    />

    {/* Right-to-left cars that sweep from right to left */}
    <Car
      className="floating-car rtl small delay-2"
      style={{ top: '18%', right: '-8%', position: 'absolute' }}
    />
    <Car
      className="floating-car rtl mid delay-1"
      style={{ top: '34%', right: '-14%', position: 'absolute' }}
    />
    <Car
      className="floating-car rtl small delay-3"
      style={{ top: '52%', right: '-6%', position: 'absolute' }}
    />
  </div>
);
        ...
        <div className="glass-card p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              ...
              className="w-full glass-button disabled:opacity-60 text-white font-semibold py-4 px-6 rounded-lg transition-colors duration-200 flex items-center justify-center space-x-2"
            >
              {isSubmitting ? (
                <>
